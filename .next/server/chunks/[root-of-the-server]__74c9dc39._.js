...
"[project]/src/algorithms/pythonPredict.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "fetchPythonPrediction": (()=>fetchPythonPrediction)
});
async function fetchPythonPrediction(endpoint, prices) {
    try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$algorithms$2f$pythonPredict$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/algorithms/pythonPredict.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        const predictedPriceARIMA = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$algorithms$2f$pythonPredict$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchPythonPrediction"])('arima', priceHistory);
        const predictedPriceLSTM = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$algorithms$2f$pythonPredict$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchPythonPrediction"])('lstm', priceHistory);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__74c9dc39._.js.map